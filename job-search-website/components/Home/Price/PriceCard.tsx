...
function PriceCard({type, price}: Props) {
  return (
    <div className='bg-gray-100 dark:bg-gray-700 p-10 rounded-lg relative'>
      {/* Type check for recommended bedge */}
      {
        type === "Standard" && (
          <div className='absolute top-7 right-7 px-6 py-1.5 bg-green-800 text-white rounded-full text-xs'>Recommended</div>
        )
      }
      {/* Type */}
