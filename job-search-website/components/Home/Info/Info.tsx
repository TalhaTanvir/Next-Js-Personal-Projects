            ...
            <div data-aos="fade-right" data-aos-anchor-placement="top-center" data-aos-delay={150} className='mt-6 text-gray-700 dark:text-gray-300'>
                ...
                <div className='mt-8'>
                    <div className='flex items-center space-x-2 mb-4'>
                        <BiCheck className='size-7 text-pink-600'/>
                    ...
                    <div className='flex items-center space-x-2 mb-4'>
                        <BiCheck className='size-7 text-pink-600'/>
                        <span className='text-gray-700 dark:text-gray-300 font-medium'>But I must explain to you how all this Post a Job</span>
                    </div>
                </div>
                <div className='mt-8'>
